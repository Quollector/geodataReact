...
export default function ListCard({country, index}) {
    ...
    return (
        <>
            <li onClick={() => setShowModal(!showModal)} className="cursor-pointer relative rounded transition-transform duration-300 hover:-translate-y-1 will-change-transform">
